...
1. Google Cloud Platform의 분석용 기업 데이터 웨어하우스
2. 편리한 표준 SQL
3. 완벽한 관리형 및 서버리스
4. 페타바이트급 스토리지 및 쿼리
5. 암호화, 내구성, 고가용성
6. 스트리밍 데이터에 대한 실시간 분석
